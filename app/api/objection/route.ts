...
const GROUNDED_THINKING_LEVEL = 'MINIMAL' as const
const STANDARD_THINKING_LEVEL = 'HIGH' as const
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logInfo('Objection review dataset summary', {
      ...
      groundedThinkingLevel: GROUNDED_THINKING_LEVEL,
      standardThinkingLevel: STANDARD_THINKING_LEVEL,
    })
      ...
      ? [
          {
            ...
            body: {
              ...
              generationConfig: {
                ...
                thinkingConfig: { thinkingLevel: GROUNDED_THINKING_LEVEL },
              },
              tools,
            },
            thinkingLevel: GROUNDED_THINKING_LEVEL,
          },
          {
            label: 'standard',
            body: {
              ...
              generationConfig: {
                temperature: 0.1,
                responseMimeType: 'application/json',
                thinkingConfig: { thinkingLevel: STANDARD_THINKING_LEVEL },
              },
            },
            thinkingLevel: STANDARD_THINKING_LEVEL,
          },
        ]
      : [
          {
    ...
    for (const requestVariant of requestVariants) {
      ...
      if (IS_DEV) {
        ...
        logInfo('Gemini objection request', {
          ...
          familyNamesRemainder,
          promptBytes: datasetForPrompt.length,
          thinkingLevel: requestVariant.thinkingLevel,
        })
      }
