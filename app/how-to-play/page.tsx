    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Pick one video game for each grid cell. Every answer has to satisfy both the row clue and the column clue at the same time.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'GameGrid can use video game platforms, genres, decades, themes, player perspectives, and game modes.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The daily puzzle resets at midnight UTC and a new board becomes available for everyone.',
        },
      },
      {
        '@type': 'Question',
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes. In addition to the daily puzzle, GameGrid also offers practice boards so you can keep playing after finishing the daily challenge.',
        },
      },
    ],
  }
    ...
    <main className="min-h-screen px-4 py-12">
      ...
      <div className="mx-auto max-w-3xl rounded-3xl border border-border bg-card/70 p-8 shadow-xl backdrop-blur-sm">
        ...
        <p className="mt-4 text-base leading-7 text-muted-foreground">
          GameGrid is a daily video game trivia puzzle where every answer has to satisfy two clues
          at once. Each cell in the 3x3 board combines one row category with one column category,
          and your job is to find a real game that matches both.
        </p>
        ...
        <section className="mt-8">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            Boards can include platforms like Xbox 360 or PC, genres like RPG or Shooter, decades
            like the 1990s, themes like Horror or Science fiction, perspectives like First person or
            Side view, and game modes like Single player or Co-operative.
          </p>
        </section>
          ...
          <div className="mt-4 space-y-4">
            <div className="rounded-2xl border border-border/80 bg-secondary/20 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                GameGrid validates answers against IGDB category data and additional game-cleanup
                rules to keep the puzzle focused on recognizable releases.
              </p>
            </div>
            <div className="rounded-2xl border border-border/80 bg-secondary/20 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Some category combinations are broad, like a major theme paired with an entire
                decade. Others are much narrower, which is part of what makes each board
                interesting.
              </p>
            </div>
            <div className="rounded-2xl border border-border/80 bg-secondary/20 p-4">
