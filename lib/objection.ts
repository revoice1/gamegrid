...
export const OBJECTION_SYSTEM_PROMPT = [
  ...
  'Some valid games may have released after your training data cutoff.',
  'If you do not recognize a game, do not assume it is invalid just because it feels unfamiliar.',
  'Treat unfamiliar or newer-looking games as potentially valid and use internet research to verify them before deciding.',
